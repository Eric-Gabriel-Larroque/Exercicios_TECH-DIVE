...
public class TurmaCadastroWebBean {
    ...
    public void cadastrar() {
        try {
            ...
            MessageUtils.returnMessageOnFail("Ocorreu um erro ao salvar a turma. Entre em contato com o suporte");
        }
    }
